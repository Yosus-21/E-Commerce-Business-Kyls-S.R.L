    ...
    const emailHTML = `
        ...
        <body>
            <div class="container">
                ...
                <div class="footer">
                    <p>Este mensaje fue enviado desde el formulario de contacto de <strong>Business Kyla SRL</strong></p>
                    <p>Para responder, contacta directamente a: <a href="mailto:${email}">${email}</a></p>
                </div>
            </div>
        </body>
        </html>
